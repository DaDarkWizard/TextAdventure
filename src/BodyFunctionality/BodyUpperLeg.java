...
public class BodyUpperLeg extends BodyPart
{
    public BodyUpperLeg()
    {
        super();
        this.setBodyPartType( BodyPartEnums.BodyPartType.UPPERLEG );
     ...
     */
    public BodyUpperLeg(ByteBuffer buffer)
    {
        super(buffer);
    }
     ...
     */
    public BodyUpperLeg(BodyUpperLeg oldPart)
    {
        super(oldPart);
    }
    ...
    {
        return BodyPartEnums.BodyPartType.UPPERLEG;
    }
    ...
    public void createUpperArm (String name, String side, CreatureDataObject creatureData, Color color)
    {
        ...
        BodyUpperLeg lowerArm = new BodyUpperLeg();
    ...
    public void createUpperLeg (String name, String side, CreatureDataObject creatureData, Color color)
    {
        ...
        BodyUpperLeg lowerLeg = new BodyUpperLeg();
